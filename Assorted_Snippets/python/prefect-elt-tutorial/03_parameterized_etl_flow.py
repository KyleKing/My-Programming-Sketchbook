"""Example with Prefect and parameterization.

Source: https://docs.prefect.io/core/tutorial/03-parameterized-flow.html

New DAG: https://docs.prefect.io/prefect-tutorial-etl-parameterized-dataflow.png
