"""Initial example with Prefect.

Source: https://docs.prefect.io/core/tutorial/02-etl-flow.html

- when deciding how large to make each function: look at the input and output data that the workflow needs at each step

New DAG: https://docs.prefect.io/prefect-tutorial-etl-dataflow.png
